...
/// install dir), so those writes would scatter into the install tree or vanish entirely.
...
pub fn workspace_theme_dir() -> PathBuf {
    // The manifest dir is crates/echo-core; themes/ lives at the workspace root.
