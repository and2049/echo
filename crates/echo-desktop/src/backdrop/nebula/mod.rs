...
//! the base toward the palette color its hue picks,. The sines run in whole turns per
...
/// quarters of full. The field gathers between about 6 and 19, its median drifting from 9 to
/// 12 around the loop, so the nebula breathes a little as well as drifts.
const GLOW_FLOOR: f32 = 7.0;
