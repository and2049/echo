...
fn enter_artist(state: &mut AppState, artist: echo_core::models::Artist) -> Option<AppEvent> {
...
mod tests {
    ...
    fn selecting_followed_artist_opens_partial_shell_immediately() {
        let mut state = AppState::new();
        state.data.followed_artists.push(echo_core::models::Artist {
            id: "artist".to_string(),
    ...
    fn selecting_search_artist_opens_partial_shell_with_image() {
        let mut state = AppState::new();
        state.data.search_results.artists.push(echo_core::models::Artist {
            id: "artist".to_string(),
