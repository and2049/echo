...
### Desktop App
 ...
 - Clicking a recent search runs it again instead of dropping back to the page underneath; the remove and clear buttons there work the same way and keep the search box focused
